...
const PrivacyPolicyPage = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 text-gray-700 leading-relaxed">
      ...
      <p className="mb-4">
        TalentSync Solutions LLC and Vale Consultants Pvt. Ltd. (“we”, “our”, “us”) is committed to protecting your privacy. 
      ...
      <p className="mb-4">
        <strong>TalentSync Solutions LLC </strong><br />
        Email: [info@talentsyncsol.com]<br />
        Phone: [+1 (718) 715-0987]<br />
        Website: [https://talentsyncsolutions.com/]
      </p>
    </div>
  );
};
