                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <p className="text-sm leading-relaxed">
                            <span className="font-medium text-2xl">TalentSync Solutions LLC </span>
                            <br />
                                       30 N Gould St Ste. NSheridan, WY 82801<br />
                                        United States
                        </p>
                        <div className="mt-4 space-y-2 text-sm">
                            ...
                            <p className="flex items-center">
                                <Mail className="w-4 h-4 mr-2" /> info@talentsyncsol.com
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mt-2">
                            ...
                            <a href="#" className="hover:text-pink-500"><Instagram className="w-6 h-6" /></a>
                            <a href="https://www.linkedin.com/company/talentsync-solutions-llc/" className="hover:text-blue-600"><Linkedin className="w-6 h-6" /></a>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="text-sm">
                            © 2025 <span className="text-orange-400">TalentSync Solutions LLC </span> All Rights Reserved
                        </div>
