    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <p className="text-gray-600 text-center leading-relaxed max-w-4xl mx-auto mb-16 text-lg">
                TalentSync Solutions LLC and Vale Consultants collaborates with leading global technology platforms to deliver secure, scalable, and high-performance solutions. Our partnerships strengthen our capabilities across software development, cloud services, cybersecurity, automation, and IT talent augmentation.
            ...
            <section className="py-16 px-4 bg-gray-50">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 mb-8 text-lg max-w-3xl mx-auto leading-relaxed">
                       At TalentSync Solutions LLC and Vale Consultants, we help organizations navigate digital transformation with expert guidance and scalable solutions.
