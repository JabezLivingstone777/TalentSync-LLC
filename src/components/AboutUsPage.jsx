    ...
    return (
        <div className="min-h-screen bg-gray-100 font-sans">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                ...
                <p className="text-gray-600 mt-4 max-w-3xl mx-auto text-center leading-relaxed">
                    TalentSync Solutions LLC   delivers strategic
                    ...
                    <div className="w-full md:w-1/2 space-y-8">
                        <div className="bg-white shadow-lg p-8 rounded-xl border border-gray-200 transition hover:shadow-2xl hover:scale-[1.03]">
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                ...
                                TalentSync Solutions LLC  is a professional consulting and
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition group hover:bg-slate-700 hover:text-white">
                    ...
                    <p className="text-gray-600 group-hover:text-white leading-relaxed mb-6">
                        Our recruitment arm keeps evolving. At TalentSync Solutions LLC , we don't just fill roles. We align with your vision of business transformation.                    </p>
            ...
            <div className="bg-gray-50 py-16">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="space-y-8 text-gray-600 leading-relaxed">
                        <p>
                            At TalentSync Solutions LLC , we are committed to building the best IT careers possible by creating the perfect match between a job seeker’s expertise and client requirements, guaranteeing a long and fruitful association for all.
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {[{
                            ...
                            label: "Phone",
                            value: "+1 (718) 715-0987"
                        }, {
                            icon: <Mail className="text-slate-700" />,
                            label: "Email",
                            value: "info@talentsyncsol.com"
                        }, {
                            icon: <MapPin className="text-slate-700" />,
                            label: "Headquarters",
                            value: "30 N Gould St Ste. NSheridan, WY 82801"
                        }].map((item, i) => (
