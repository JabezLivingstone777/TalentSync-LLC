...
const MobileAppDevelopmentPage = () => {
    const data = [
        { id: 1, title: "Mobile Application Development", content: "TalentSync Solutions LLC  is a leading software company with a decade of experience in mobile app development services.", icon: <span className="text-slate-900 text-4xl">📱</span> },
        ...
        { id: 3, title: "Mobile Web Optimization", content: "Our team of mobile veterans optimize your web application to deliver an excellent experience across various mobile devices. At TalentSync Solutions LLC , one of our objectives is to ensure accessibility on the go with our mobile web development services.", icon: <span className="text-orange-500 text-4xl">🌐</span> },
        ...
        { id: 8, title: "IT System & Software Integration Services", content: "TalentSync Solutions LLC  is a software integration company that can help you integrate enterprise applications, data, and processes in the most efficient way.", icon: <span className="text-orange-500 text-4xl">🔗</span> },
    ];
                        ...
                        const [cards, setCards] = React.useState([
                            {
                                ...
                                img: nativeApp,
                                desc:
                                    "Our mobile team at TalentSync Solutions LLC  creates apps for a specific mobile operating system such as iOS or Android using the latest tools and languages."
                            },
                            {
            ...
            <section className="py-12 bg-white">
                <div className="max-w-7xl mx-auto px-4 lg:max-w-[80%]">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-slate-900 mb-12 sm:mb-16">
                        Why Choose TalentSync Solutions LLC ?
                    </h2>
