                ...
                <div className="max-w-7xl mx-auto px-4 text-center relative">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-4xl font-bold text-slate-800 mb-4">
                            Welcome to TalentSync Solutions LLC 
                        </h2>
                    ...
                    <div className="bg-white py-16">
                        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
                            ...
                            {[{
                                ...
                                desc: "Meaningful career opportunities in top organizations.Looking to build your career with the right guidance, training, and opportunities? At TalentSync Solutions LLC & Vale Consultants Pvt. Ltd., we help freshers and experienced professionals connect with leading organizations and reputable roles that align with their skills and aspirations.",
                                link: "/mobile"
                            }, {
                                title: "Employees",
