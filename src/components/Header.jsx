...
const Header = () => {
  ...
  return (
    <>
      {/* Fixed Header */}
      <header className="fixed w-full top-0 left-0 z-50 bg-white text-gray-800 shadow-md h-16 lg:h-20 transition-all duration-300">
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-6 ">
              ...
              <button className="ml-6 bg-slate-900 hover:bg-slate-700 px-4 py-2 rounded-md text-sm flex items-center space-x-2 transition-colors font-bold text-white">
                ...
                <span>
                  <a href="mailto:contact@TalentSync Solutions ">Mail Us</a>
                </span>
              </button>
            </div>
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              <motion.div
                ...
                className="lg:hidden bg-white py-4 shadow-inner"
              >
