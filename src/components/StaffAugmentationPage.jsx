            ...
            <div className="container mx-auto px-4 py-10 w-full lg:w-10/12">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 items-center">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed mb-4">
                                    Our recruitment arm keeps evolving. At TalentSync Solutions LLC , we don't just fill roles. We align with your vision of
                        ...
                        <div className="border border-gray-200 rounded-lg overflow-hidden shadow-md">
                            ...
                            {openAccordion === 'contract-staffing' && (
                                <div className="bg-gray-50 px-6 py-4 space-y-4">
                                    ...
                                    <p className="text-gray-600">
                                        At TalentSync Solutions LLC , contract staffing is not just a quick fix; it is a strategic answer to your call that streamlines those tightest timeframes, keeps the project on time, meets your budget, and keeps you ahead in this ever changing-market.
                                    </p>
                            ...
                            {openAccordion === 'permanent-hiring' && (
                                <div className="bg-gray-50 px-6 py-4 space-y-4">
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        At TalentSync Solutions LLC  , we know the importance of customization. Our tech team of managers and strategists are here to help you with a concrete roadmap and help you <b><i>Build Your Own Team</i></b>. Talk to functional consultants and we will guide you to the smartest fit!
                                    </p>
                                </div>
                            )}
                        </div>
                ...
                <div className="bg-linear-to-b from-white to-gray-50 py-10 text-center">
                    ...
                    <p className="text-gray-500 text-sm sm:text-base md:text-lg mb-4 max-w-3xl mx-auto">
                        At TalentSync Solutions LLC  , we know the importance of customization. Our tech team of managers and strategists are here to help you with a concrete roadmap and help you <span className="font-bold italic text-gray-600">Build Your Own Team</span>.
                    </p>
